...
public class RegisterCandidatesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //autoComplete
        String[] councilor = getResources().getStringArray(R.array.councilor);

        AutoCompleteTextView editText = findViewById(R.id.candidate_role);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                R.layout.support_simple_spinner_dropdown_item, councilor);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == PICK_IMAGE || resultCode == RESULT_OK) {
            ...
            Picasso.get().load(imageUrl).resize(400,400).into(imageButton);
