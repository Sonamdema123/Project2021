...
public class gccResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gcc_result);
...
//        collectionReference = fStore.collection("Candidates");
        ...
        gotonext = findViewById(R.id.gotoResult5);

        gotonext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), bgscResult.class));
                finish();
            }
        });
