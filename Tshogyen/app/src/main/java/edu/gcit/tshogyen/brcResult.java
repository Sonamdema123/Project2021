...
public class brcResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brc_result);
...
//        collectionReference = fStore.collection("Candidates");
        ...
        gotonext = findViewById(R.id.gotoResult2);

        gotonext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), grcResult.class));
                finish();
            }
        });
