...
public class grcResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grc_result);
...
//        collectionReference = fStore.collection("Candidates");
        ...
        gotonext = findViewById(R.id.gotoResult3);

        gotonext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), bccResult.class));
                finish();
            }
        });
