...
public class ggscResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ggsc_result);
...
//        collectionReference = fStore.collection("Candidates");
        ...
        gotonext = findViewById(R.id.gotoResult7);

        gotonext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), bpcResult.class));
                finish();
            }
        });
