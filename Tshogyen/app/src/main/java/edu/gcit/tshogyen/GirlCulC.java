...
public class GirlCulC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girl_cul_c);
...
//        collectionReference = fStore.collection("Candidates");
        ...
        gotonext = findViewById(R.id.gotoBGSC);

        gotonext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), BGSC.class));
                finish();
            }
        });
